...
var getSessionToken = _require2.getSessionToken;
var ajax = _require2.ajax;
...
var createApiUrl = function createApiUrl(_ref) {
  ...
  var service = _ref$service === undefined ? 'api' : _ref$service;
  var _ref$version = _ref.version;
  var version = _ref$version === undefined ? '1.1' : _ref$version;
  var path = _ref.path;
...
var request = function request(_ref2) {
  ...
  var _ref2$signKey = _ref2.signKey;
  var signKey = _ref2$signKey === undefined ? true : _ref2$signKey;
...
var parseDate = _require.parseDate;
...
var _request = _require._request;
...
module.exports = function (AV) {
  ...
  _.extend(AV.Cloud, /** @lends AV.Cloud */{
    ...
    requestSmsCode: function requestSmsCode(data) {
      ...
      return _request("requestSmsCode", null, null, 'POST', data);
    },
    ...
    */
    ...
    save: function save(options) {
      ...
      if (!this._previousSave) {
        if (this._data) {
          (function () {
            var mimeType = _this3.get('mime_type');
            _this3._previousSave = _this3._fileToken(mimeType).then(function (uploadInfo) {
...
AV.init = function init(options) {
  ...
  var hookKey = options.hookKey;
  var _options$region = options.region;
  var region = _options$region === undefined ? 'cn' : _options$region;
  var serverURLs = options.serverURLs;
  var _options$disableCurre = options.disableCurrentUser;
  var disableCurrentUser = _options$disableCurre === undefined ? false : _options$disableCurre;
...
AV._setServerURLs = function (urls) {
  var disableAppRouter = arguments.length <= 1 || arguments[1] === undefined ? true : arguments[1];
...
var isNullOrUndefined = _require2.isNullOrUndefined;
...
module.exports = function (AV) {
  ...
  /** @lends AV.Object.prototype */{
    ...
    fetch: function fetch() {
      ...
      var self = this;
      var request = _request('classes', this.className, this.id, 'GET', fetchOptions, options);
